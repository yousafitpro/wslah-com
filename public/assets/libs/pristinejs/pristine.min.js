! function(e, r) {
    ...
    var n = {
        ...
        a = {},
        o = function(r, t) {
            t.name = r, t.msg || (t.msg = e[r]), void 0 === t.priority && (t.priority = 1), a[r] = t
        };
    ...
    function l(e, t, s) {
        ...
        function u(e) {
            for (var t, n = [], i = !0, s = 0; e.validators[s]; s++) {
                ...
                if (o[0] = e.input.value, !a.fn.apply(e.input, o)) {
                    if (i = !1, (t = a.msg) && t.constructor && t.call && t.apply) n.push(a.msg(e.input.value, o));
                    else {
        ...
        function f(e) {
            ...
            var r = function(e, r) {
                ...
                t = null,
                n = null;
            return (t = o.config.classTo === o.config.errorTextParent ? r : r.querySelector("." + o.config.errorTextParent)) && ((n = t.querySelector(".pristine-error")) || ((n = document.createElement(o.config.errorTextTag)).className = "pristine-error " + o.config.errorTextClass, t.appendChild(n), n.pristineDisplay = n.style.display)), e.errorElements = [r, n]
        }
        ...
        function c(e) {
            var r = f(e),
                t = r[0],
                n = r[1];
            t && (t.classList.remove(o.config.successClass), t.classList.add(o.config.errorClass)), n && (n.innerHTML = e.errors.join("<br/>"), n.style.display = n.pristineDisplay || "")
        }
        ...
        function p(e) {
            var r = function(e) {
                var r = f(e),
                    t = r[0],
                    n = r[1];
                return t && (t.classList.remove(o.config.errorClass), t.classList.remove(o.config.successClass)), n && (n.innerHTML = "", n.style.display = "none"), r
            }(e)[0];
            r && r.classList.add(o.config.successClass)
        }
        return function(e, r, t) {
            e.setAttribute("novalidate", "true"), o.form = e, o.config = function(e, r) {
                for (var t in r) t in e || (e[t] = r[t]);
                return e
            }(r || {}, n), o.live = !(!1 === t), o.fields = Array.from(e.querySelectorAll("input:not([type^=hidden]):not([type^=submit]), select, textarea")).map(function(e) {
                var r = [],
                    t = {},
                    n = {};
                return [].forEach.call(e.attributes, (function(e) {
                    if (/^data-pristine-/.test(e.name)) {
                        ...
                        if (s.endsWith("-message")) return void(n[s.slice(0, s.length - 8)] = e.value);
                ...
                })), o.live && e.addEventListener(~["radio", "checkbox"].indexOf(e.getAttribute("type")) ? "change" : "blur", function(e) {
                    o.validate(e.target)
                }.bind(o)), e.pristine = {
                    input: e,
                    validators: r,
            ...
            Array.from(o.form.querySelectorAll(".pristine-error")).map((function(e) {
                e.parentNode.removeChild(e)
            })), Array.from(o.form.querySelectorAll("." + o.config.classTo)).map((function(e) {
                e.classList.remove(o.config.successClass), e.classList.remove(o.config.errorClass)
            }))
        }, o.destroy = function() {
            o.reset(), o.fields.forEach((function(e) {
